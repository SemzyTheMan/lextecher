...
const HeaderSection = () => {
  return (
    <header className="w-full grid grid-cols-2  h-[37.5rem] place-items-center px-[4rem] bg-primary">
      <div>
        <p className="text-white text-[2.5rem] font-semibold">
          Navigating legal complexities <span className="text-lightOrange italic">should not</span> hinder your tech
          innovations. Let’s grow your company, not your legal headaches.
        </p>
